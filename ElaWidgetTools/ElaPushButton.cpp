...
void ElaPushButton::paintEvent(QPaintEvent* event)
{
    ...
    case ElaPushButtonType::Appearance::Primary:
        bgColor = isEnabled() ? (d->_isPressed ? ElaThemeColor(d->_themeMode, colorBrandBackgroundPressed)
                                               : (underMouse() ? ElaThemeColor(d->_themeMode, colorBrandBackgroundHover)
                                                               : ElaThemeColor(d->_themeMode, colorBrandBackground)))
